...
Telegrambot.prototype.initiate = function() {
    ...
    this.slimbotRefresher = function(slimbot,catcher) {
        ...
        this.start = function() {
            console.log(new Date(), this._key, 'tgBotRF: called start');
            this._stopped = false;
            this.poll();
        };
        this.stop = function() {
            console.log(new Date(), this._key, 'tgBotRF: called stop');
            this._stopped = true;
            self.runningState = 1;
        ...
        this.poll = function() {
            self.debugLogging && console.log(new Date(), this._key, 'tgBotRF: called poll');
        ...
        this.getName = function() {
            self.debugLogging && console.log(new Date(), this._key, 'tgBotRF: called getName');
            if (!slimbot) return;
        ...
        this.reset = function() {
            console.log(new Date(), this._key, 'tgBotRF: called reset');
            this.stop();
            if (slimbot) {
        ...
        this.refresh = function() {
            self.debugLogging && console.log(new Date(), this._key, 'tgBotRF: called refresh');
            clearTimeout(this._timeout2);
            if (!this._stopped) {
