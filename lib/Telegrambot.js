	...
	switch(type) {
		...
		default:
			...
			output = [
				...
				[{text: "\u{1F300}", callback_data: "power_menu"},{text: "\u{1F30A}", callback_data: "water_menu"},{text: "\u{1F507}", callback_data: "notif_off"},{text: "\u{1F50A}", callback_data: "notif_on"},{text: "\u{1F504}", callback_data: "maps_menu"}]
			];
	}
