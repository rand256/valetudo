...
Telegrambot.prototype.initiate = function() {
    ...
    this.slimbotRefresher = function() {
        this._timeout = 0;
        this._timeout2 = 0;
        this._stopped = false;
        this._key = Math.random();
        this.start = function() {
            console.log(new Date(), 'tgBotRF:', this._key, 'called start');
            this._stopped = false;
            this.poll();
        };
        this.stop = function() {
            console.log(new Date(), 'tgBotRF:', this._key, 'called stop');
            this._stopped = true;
            self.runningState = 1;
        ...
        this.poll = function() {
            self.debugLogging && console.log(new Date(), 'tgBotRF:', this._key, 'called poll');
        ...
        this.getName = function() {
            self.debugLogging && console.log(new Date(), 'tgBotRF:', this._key, 'called getName');
        ...
        this.reset = function() {
            console.log(new Date(), 'tgBotRF:', this._key, 'called reset');
            this.stop();
            if (self.slimbot) {
                self.slimbot._timeout = new self.slimbotRefresher();
                self.slimbot._timeout.start();
            }
        };
        this.refresh = function() {
            self.debugLogging && console.log(new Date(), 'tgBotRF:', this._key, 'called refresh');
            clearTimeout(this._timeout2);
            if (!this._stopped) {
    ...
    this.slimbot._timeout = new this.slimbotRefresher();
